...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run round2 external conditioning roundtrip.")
...
def main() -> None:
    ...
    steps = [
        [
            sys.executable,
            str(project_root / "scripts" / "pipeline" / "validate_round2_external.py"),
            "--artist-id",
            args.artist_id,
            "--input-dir",
            str(input_dir),
        ...
        [
            sys.executable,
            str(project_root / "scripts" / "pipeline" / "merge_round2_external.py"),
            "--artist-id",
            args.artist_id,
            "--input-dir",
            str(input_dir),
