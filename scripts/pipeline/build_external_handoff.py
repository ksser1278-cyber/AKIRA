...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build external enrichment handoff manifests for active conditioning tracks.")
...
def render_report(payload: dict[str, object]) -> str:
    lines = [
        f"# External Handoff: {payload['artist_id']}",
        "",
...
def main() -> None:
    ...
    payload = build_external_handoff_payload(project_root, args.artist_id)
    output_dir = project_root / "data" / "_global" / "external_handoff" / args.artist_id
