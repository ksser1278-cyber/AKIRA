...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run generation_safety promotion external roundtrip.")
...
def main() -> None:
    ...
    steps = [
        [
            sys.executable,
            str(project_root / "scripts" / "pipeline" / "validate_generation_safety_promotion_external.py"),
            "--artist-id",
            args.artist_id,
            "--input-dir",
            str(input_dir),
        ...
        [
            sys.executable,
            str(project_root / "scripts" / "pipeline" / "merge_generation_safety_promotion_external.py"),
            "--artist-id",
            args.artist_id,
            "--input-dir",
            str(input_dir),
