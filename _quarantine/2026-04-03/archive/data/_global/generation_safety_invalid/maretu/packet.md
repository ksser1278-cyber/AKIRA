# Generation Safety Invalid Packet: maretu
...
- `maretu_pink` / score `0.25` / blockers `missing_provenance, partial_grounding, mode_fit_unverified, renderer_policy_block` / next `add lyric_sources and metadata_sources with trusted statuses`

## Incoming Directory

- `C:\JPop_Songwriter\AKIRA ENGINE\data\_global\generation_safety_invalid\maretu\incoming`
