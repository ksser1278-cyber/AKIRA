# Generation Safety Invalid Packet: neru
...
- `neru_tokyo_teddy_bear` / score `0.2` / blockers `missing_provenance, partial_grounding, renderer_policy_block` / next `add lyric_sources and metadata_sources with trusted statuses`

## Incoming Directory

- `C:\JPop_Songwriter\AKIRA ENGINE\data\_global\generation_safety_invalid\neru\incoming`
